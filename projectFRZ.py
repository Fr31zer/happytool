...
while password != 193920:
    print('Пароль не верный ')
    password = int(input('Введите пароль еще раз: '))
print('Пароль верный! Спасибо за покупку.')
...
█▄█ █▀█ █▀█ █▀█ █▄█
█▀█ █▀█ █▀▀ █▀▀  █  
РАЗРАБОТЧИК: @Fr31zer /// ТГК: @FreizerSOFTS \n'''), pystyle.Colors.red, interval = 0.001)
    else:
        os.system("clear")
        pystyle.Write.Print(pystyle.Center.XCenter('''\n  
▄▀▀▀▄▄▄▄▄▄▄▀▀▀▄
...
[15] Web-crawler  
[16] DDOS 2.0 
[17] Генератор вымышленной карты   
[18] Поиск по mac адресу
...
"Mozilla/5.0 (X11; Linux x86_64; rv:{0}.0) Gecko/{0}{1:02d} Firefox/{0}.0",
    ...
    if choice == "22":
        pystyle.Write.Print("\n[+] СОЗДАТЕЛЬ @Fr31zer \n", pystyle.Colors.red, interval = 0.005)
    if choice == "23":
        sure = pystyle.Write.Input("Вы действительно хотите выйти? Y/N: ",pystyle.Colors.red)
